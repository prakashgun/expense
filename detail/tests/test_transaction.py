...
TRANSACTION_LIST_URL = reverse('detail:transaction-list')
TRANSACTION_DETAIL_URL = reverse('detail:transaction-detail', kwargs={'pk': 'some_id'})
ACCOUNT_LIST_URL = reverse('detail:account-list')
CATEGORY_LIST_URL = reverse('detail:category-list')
